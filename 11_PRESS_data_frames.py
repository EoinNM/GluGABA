...
def concatenate(workspace, PRESS_voxels, population, data_type, days):
    ...
    print '========================================================================================'
    print '                            GluGABA - 11_PRESS_Create_DataFrame                         '
    print '========================================================================================'
    ...
    for subject in population:
        ...
        #pull demographics from rda file header (used ACC but info avaulable from other also)
        ...
        kg   = [i[16:18] for i in rda if 'PatientWeight' in i][0]
        date = [i[13:21] for i in rda if 'StudyDate' in i][0]
        ...
        for day in days:
            for se_voxel in PRESS_voxels:
                ...
                for dtype in data_type:
                    ...
                    columns = ['Age' ,  'WeightKG', 'Date' 'FWHM'  , 'SNR'  , 'Shift', 'Ph0', 'Ph1', 'GM', 'WM', 'CSF',
                                        'Cre'    ,  'Cre%'      ,
                                        'tCho'   , 'tCho%'      ,
                                        'NAA'    ,  'NAA%'      ,
                                        'NAAG'   ,  'NAAG%'     ,
        ...
        dataframe.to_csv(os.path.join(dataframe_dir, 'LCM_%s_%s_%s.csv'%(se_voxel, day, dtype)))
