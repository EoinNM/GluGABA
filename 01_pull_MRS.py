...
def pull_svs(test_population, days, voxels, PRESS_voxels, MPRESS_voxels, workspace, zfs):
    
    print '========================================================================================'
    print '                                GluGABA - 01_Pull_SVS                                 '
    print '========================================================================================'
    ...
    for subject in population:
        ...
        for day in days:   
            ...
            if not os.path.isfile(os.path.join(workspace, 'DATA', subject, 'SVS', day)):
            
                #data sources
                sub_dir = mkdir_path(os.path.join(workspace, 'DATA', subject, 'SVS', day))
               ...
               #rename zips
                ...
                for se_voxel in PRESS_voxels:
                    ...
                    if os.path.isfile(file):
                        ...
                        print 'no PRESS rda files here to copy - Check naming of files'
                ...
                for mp_voxel in MPRESS_voxels:
                    ...
                    if os.path.isfile(file):
                        ...
                        print 'no MEGA-PRESS rda files here to copy - Check naming of files'
                    ...
                    for mpress_h20_dat in glob.glob(os.path.join(sub_dir, 'unzipped_mrs', '*mpw529_M1_ref*')):
                        ...
                        os.system('cp %s %s/%s_w.dat' % (twx_MPRESS_h20_src, twx_MPRESS_h20_dst, mp_voxel))
...
pull_svs(population, days, voxels, PRESS_voxels, MPRESS_voxels, workspace, zfs)
